...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= base_url()?>/asset/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl background-image">
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="<?= base_url()?>user/do_login" method="POST">
                <div class="mb-3">
